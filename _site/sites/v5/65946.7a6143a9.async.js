"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[65946],{65946:function(S,p,d){d.r(p);var w=d(168400),h=d.n(w),y=d(97857),P=d.n(y),s=d(283926),u=d(65630),M=d(385956),f=d(667294),c=d(785893),m,v,x,b,C;s.ZP.registerNode("behavior-start-node",{draw:function(e,n){var l=s.ZP.Util.getTextSize(e.label,16)[0],r=[l+20*2,48],t=n.addShape("rect",{name:"start-node",attrs:{width:r[0],height:r[1],y:-r[1]/2,radius:8,fill:"#fff"}});return n.addShape("text",{attrs:{text:"".concat(e.label),fill:"rgba(0, 0, 0, 0.88)",fontSize:16,fontWeight:500,x:20,textBaseline:"middle"},name:"start-node-text"}),t},getAnchorPoints:function(){return[[0,.5],[1,.5]]}}),s.ZP.registerNode("behavior-sub-node",{draw:function(e,n){var l=s.ZP.Util.getTextSize(e.label,14)[0],r=16,t=[l+16*2+(e.targetType?12:0)+(e.link?20:0),40],o=n.addShape("rect",{name:"sub-node",attrs:{width:t[0],height:t[1],y:-t[1]/2,radius:8,fill:"#fff",cursor:"pointer"}});if(n.addShape("text",{attrs:{text:"".concat(e.label),x:e.targetType?12+16:r,fill:"rgba(0, 0, 0, 0.88)",fontSize:14,textBaseline:"middle",cursor:"pointer"},name:"sub-node-text"}),e.targetType&&n.addShape("rect",{name:"sub-node-type",attrs:{width:8,height:8,radius:4,y:-4,x:12,fill:e.targetType==="mvp"?"#1677ff":"#A0A0A0",cursor:"pointer"}}),e.children){var i=e.children,a=i.length;n.addShape("rect",{name:"sub-node-children-length",attrs:{width:20,height:20,radius:10,y:-10,x:t[0]-4,fill:"#404040",cursor:"pointer"}}),n.addShape("text",{name:"sub-node-children-length-text",attrs:{text:"".concat(a),x:t[0]+6-s.ZP.Util.getTextSize("".concat(a),12)[0]/2,textBaseline:"middle",fill:"#fff",fontSize:12,cursor:"pointer"}})}return e.link&&n.addShape("dom",{attrs:{width:16,height:16,x:t[0]-12-16,y:-8,cursor:"pointer",html:`
          ...
          `}}}}},"rect");var D=function(e){var n=function l(r){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:0,o=P()({},r);switch(t){case 0:o.type="behavior-start-node";break;case 1:o.type="behavior-sub-node",o.collapsed=!0;break;default:o.type="behavior-sub-node";break}return r.children&&(o.children=r.children.map(function(i){return l(i,t+1)})),o};return n(e)},B=(0,u.kc)(function(){return{container:(0,u.iv)(m||(m=h()([`
    width: 100%;
    height: 600px;
  ...
  `])))}}),F=function(e){var n=e.data,l=(0,f.useRef)(null),r=B(),t=r.styles,o=(0,M.useRouteMeta)();return(0,f.useEffect)(function(){var i=new s.ZP.TreeGraph({container:l.current,width:l.current.scrollWidth,height:l.current.scrollHeight,renderer:"svg",modes:{default:["collapse-expand","drag-canvas"]},defaultEdge:{type:"cubic-horizontal",style:{lineWidth:1,stroke:"#BFBFBF"}},layout:{type:"mindmap",direction:"LR",getHeight:function(){return 48},getWidth:function(g){return s.ZP.Util.getTextSize(g.label,16)[0]+40},getVGap:function(){return 10},getHGap:function(){return 60},getSide:function(g){return g.data.direction}}});i.on("node:mouseenter",function(a){i.setItemState(a.item,"hover",!0)}),i.on("node:mouseleave",function(a){i.setItemState(a.item,"hover",!1)}),i.on("node:click",function(a){var g=a.item.getModel(),E=g.link;E&&(window.location.hash=E)}),i.data(D(n)),i.render(),i.fitCenter()},[]),(0,c.jsxs)("div",{ref:l,className:t.container,children:[(0,c.jsx)("div",{className:t.title,children:"".concat(o.frontmatter.title," \u884C\u4E3A\u6A21\u5F0F\u5730\u56FE")}),(0,c.jsxs)("div",{className:t.tips,children:[(0,c.jsx)("div",{className:t.mvp,children:"MVP \u884C\u4E3A\u76EE\u7684"}),(0,c.jsx)("div",{className:t.extension,children:"\u62D3\u5C55\u884C\u4E3A\u76EE\u7684"})]})]})};p.default=F}}]);
