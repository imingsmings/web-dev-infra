(window.webpackJsonp=window.webpackJsonp||[]).push([[36],{3776:function(s,o,a){s.exports={content:["section",["p","A breadcrumb displays the current location within a hierarchy. It allows going back to states higher up in the hierarchy."],["h2","When To Use"],["ul",["li",["p","When the system has more than two layers in a hierarchy."]],["li",["p","When you need to inform the user of where they are."]],["li",["p","When the user may need to navigate back to a higher level."]]],["h3","Usage upgrade after 4.24.0"],function(){var t=a(0),u=a(42),p=e(a(499));function e(n){return n&&n.__esModule?n:{default:n}}return t.createElement(p.default,{message:"After version 4.24.0, we provide a simpler usage <Breadcrumb.Item menu={{ items: [...] }}> with better performance and potential of writing simpler code style in your applications. Meanwhile, we deprecated the old usage in browser console, we will remove it in antd 5.0."})},["pre",{lang:"jsx",highlighted:`<span class="token comment" spellcheck="true">// works when >=4.24.0, recommended \u2705</span>
