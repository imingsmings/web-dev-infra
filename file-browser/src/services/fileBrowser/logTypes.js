...
export const SOUTHBOUND_LOG_TYPE_GROUP_MAP = Object.freeze({
  ...
  [SOUTHBOUND_LOG_TYPES.DEBUG]: LOG_TYPE_GROUPS.DEBUG,
  [SOUTHBOUND_LOG_TYPES.EVENT]: LOG_TYPE_GROUPS.EVENT,
  [SOUTHBOUND_LOG_TYPES.EXCEPTION]: LOG_TYPE_GROUPS.EXCEPTION,
...
export const LOG_TYPE_GROUP_LABELS = Object.freeze({
  ...
  [LOG_TYPE_GROUPS.DEBUG]: 'Debug类',
  [LOG_TYPE_GROUPS.EVENT]: '事件类',
  [LOG_TYPE_GROUPS.EXCEPTION]: 'Exception类',
...
export const SOUTHBOUND_LOG_TYPE_LABELS = Object.freeze({
  ...
  [SOUTHBOUND_LOG_TYPES.DEBUG]: 'Debug日志',
  [SOUTHBOUND_LOG_TYPES.EVENT]: 'Event日志',
  [SOUTHBOUND_LOG_TYPES.EXCEPTION]: 'Exception日志',
...
export const SOUTHBOUND_LOG_TYPE_OPTIONS = Object.freeze([
  ...
  },
  {
    ...
    label: 'Exception日志',
    value: SOUTHBOUND_LOG_TYPES.EXCEPTION
  },
  {
    group: LOG_TYPE_GROUPS.DEBUG,
    label: 'Debug日志',
    value: SOUTHBOUND_LOG_TYPES.DEBUG
  },
  {
